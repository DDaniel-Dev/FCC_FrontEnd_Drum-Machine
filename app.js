!function(){ 
  ...
  function r(e,r,a){
    return r&&t(e.prototype,r),a&&t(e,a),Object.defineProperty(e,"prototype",{writable:!1}),e
  }
  ...
  function o(e){
    return o=Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(e){
      return e.__proto__||Object.getPrototypeOf(e)},o(e)
  }
  
  function n(e,t){
    return n=Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e,t){
      return e.__proto__=t,e},n(e,t)
  }
  ...
  m=function(t){
    ...
    function n(t){
      var r;
      return e(this,n),(r=o.call(this,t)).state={padStyle:u},r.playSound=r.playSound.bind(i(r)),r.handleKeyPress=r.handleKeyPress.bind(i(r)),r.activatePad=r.activatePad.bind(i(r)),r
    }
    return r(n,[{
      ...
      value:function(){
        ...
        return e=this.props.power ? this.props.currentPadBank.map((function(e,r,a){
          return React.createElement(m,{
            ...
            power:t.props.power,
            updateDisplay:t.props.updateDisplay})})) : this.props.currentPadBank.map((function(e,r,a){
              return React.createElement(m,{
                clip:"#",
                clipId:a[r].id,
                keyCode:a[r].keyCode,
                keyTrigger:a[r].keyTrigger,
                power:t.props.power,
                updateDisplay:t.props.updateDisplay})})), React.createElement("div",{
                  className:"pad-bank"},e)}}]),n
  }(),
  ...
  h=function(t){
    ...
    function n(t){
      ...
      r.clearDisplay=r.clearDisplay.bind(i(r)),r
    }
    return r(n,[{
      key:"powerControl",
      value:function(){
      ...
      },
      {
        ...
        value:function(e){
          ...
          this.state.power&&(this.setState({
            ...
            setTimeout((function(){return t.clearDisplay()}),1e3))}
      },
      {
        key:"clearDisplay",
        value:function(){
      ...
      },
      {
        ...
        value:function(){
          ...
          r=this.state.currentPadBank===l ? {float:"left"}:{float:"right"};
          return[].slice.call(document.getElementsByClassName("clip")).forEach(
            (function(t){
          ...
          React.createElement("div",{
            ...
            React.createElement("div",{className:"controls-container"},
              ...
              React.createElement("div",{className:"control"},
                ...
                React.createElement("div",{className:"select",onClick:this.selectBank},React.createElement("div",{className:"inner",style:r}))
              )
            )
          )
        }
